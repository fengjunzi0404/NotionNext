...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '在博客的每一句话里，一幅幅清晰的画面跃然纸上，仿佛将想象化为现实，带您穿越无限的心灵之境。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '明悦科技', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '树欲静而风不止', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mingyuekeji.eo.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '电脑技巧, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '481603256@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.win3000.com/m00/19/5e/c5534b9c812ee177b2ad9a5c01459e6b.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '明悦科技', // 站点描述，被notion中的页面描述覆盖
